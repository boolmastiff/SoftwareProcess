...
namespace SoftwareProcess.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(UcolContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Year,Programme_Code,Programme_Version_Description,Intake_Code,Ministry_Code,ProgPoints,Owner_Faculty,ProgLevel,Programme_EFTS,Module_Code,Module_Description,Level,Module_Credits,Module_EFTS,TSC_Category,Funding_Classification")] Course course)
        {
            if (id != course.ID)
            {
                return NotFound();
