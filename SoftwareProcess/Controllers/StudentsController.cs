...
namespace SoftwareProcess.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(UcolContext context)
        {
            _context = context;
        }
        ...
        //Need to create Method to Log in
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,First_name,Surname,Institution,Department,Email_address,LDFTC")] Student student)
        {
            if (id != student.ID)
            {
                return NotFound();
